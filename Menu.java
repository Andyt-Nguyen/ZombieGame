public class Menu {
    public static void showHelpMenu() {
        ...
        System.out.println("------------------------------------------------------------------");
        System.out.println(" open [object]        |    to open objects");
        System.out.println(" search [object]      |    to search objecst");
        System.out.println(" pickup [object]      |    to pick up objects");
        System.out.println(" examine [object]     |    to get more detail from an object");
        System.out.println(" read [object]        |    to read");
        System.out.println(" unlock [object]      |    to unlock an object");
