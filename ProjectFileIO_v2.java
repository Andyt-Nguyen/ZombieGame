  ...
  *********************************************************************************************************************/
  ...
  public class ProjectFileIO_v2 {
      ...
      public static void writeNewPlayer(String name, String password, int hp, int bulletCount, int knifeCount, int appleCount,
          ...
          Person playerNew = new Person(name, password, hp, bulletCount, knifeCount, appleCount, steakCount, keyCount, xpos, ypos, specialKey);
      ...
      private static void writePlayerLines(){
          ...
          for (int i = 0; i < playerArrayList.size(); i++){
            ...
            // int specialKey
                ...
                pw.println(playerArrayList.get(i).getKeyCount());
